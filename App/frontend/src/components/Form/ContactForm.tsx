...
const ContactForm: React.FC = () => {
  ...
  const handleName = (e:React.ChangeEvent<HTMLInputElement>) => { dispatch(updateName(e.target.value))} 
  const handleEmail = (e:React.ChangeEvent<HTMLInputElement>) => { dispatch(updateEmail(e.target.value))}
